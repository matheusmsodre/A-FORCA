...
alert("OLÁ, "+name+", BEM VINDO, VAMOS JOGAR O JOGO DA FORCA! ANTES DE COMCEÇAR, IREI LHE DAR ALGUMAS INFORMAÇÕES SOBRE O JOGO, VAMOS LÁ?!")
...
alert("AGORA VAMOS SORTEAR SUA PALVRA, ESTÁ PRONTO?!")
...
if(sorteio==2){
    alert("SORTEAMOS  SUA  PALAVRA, ELA POSSUI 8 LETRAS!\n\n_ _ _ _ _ _ _ _")
...
if(sorteio==3){
    alert("SORTEAMOS  SUA  PALAVRA, ELA POSSUI 13 LETRAS!\n\n_ _ _ _ _ _ _   _ _ _ _ _ _")
...
if(sorteio==4){
    alert("SORTEAMOS  SUA  PALAVRA, ELA POSSUI 7 LETRAS!\n\n _ _ _ _ _ _ _")
let x = ["B","E","L","G","I","C","A"];
let y = ["_","_","_","_","_","_","_",];
let i = true;
...
document.write("S2 FIQUE EM CASA S2")
